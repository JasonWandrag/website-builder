    ...
    children: sections.map((section, index) =>
        createElement("section", {
            children: [
                createElement("h1", {
                    children: [createText(section)],
                    attributes: [createAttribute("style", `text-transform: uppercase; margin-bottom: 20px`), createAttribute('contenteditable')]
                }),
                createElement("p", {
                    children: [createText("Lorem ipsum dolor sit amet consectetur adipisicing elit. Et officiis facilis officia, tempora inventore earum provident! Voluptatem minima, repellendus itaque earum dolor omnis eos ipsa unde tempore suscipit rem nobis.")],
                    attributes: [createAttribute("style", `text-align: center;`), createAttribute('contenteditable')]
                }),
            ],
            attributes: [
...
const app = createElement("div", { children: [navbar, content, footer], attributes: [createAttribute("id", "app")] });
        ...
        case "text":
            return createElement("input", {
                attributes: [
                    ...
                    createAttribute("style", `text-align: center; padding: 10px; display: block; width: 100%`),
                ],
            })
        case "email":
            return createElement("input", {
            ...
            return createElement("label", {
                children: [createElement("input", {
                    attributes: [
                        ...
                        createAttribute('name', elementMarkdown.name),
                        createAttribute("style", `text-align: center; padding: 10px; display: block`),
                    ],
                }),
        ...
        case "form":
            return createElement(elementMarkdown.variantType, {
                attributes: [
                    ...
                    createAttribute("style", `text-align: center; padding: 10px; background: rgba(255, 255, 255, 0.3); display: flex; flex-direction: column`),
                ],
            })
    }
}
...
const createMediaUI = (elementMarkdown) => {
    ...
    if (elementMarkdown.variantType === "img") return createElement("img", {
        attributes: [
            createAttribute('src', elementMarkdown.src),
            createAttribute('alt', elementMarkdown.alt),
            createAttribute("style", `width: 100%; height: 100%; object-fit: cover; object-position: center center;`)
        ]
    })
}
...
const generateUI = elementMarkdown => {
    if (elementMarkdown.elementType === "input") return createInputUI(elementMarkdown)
    if (elementMarkdown.elementType === "text") return createTextUI(elementMarkdown)
    if (elementMarkdown.elementType === "media") return createMediaUI(elementMarkdown)
}
...
const generateSection = sectionMarkdown => {
    ...
    for(let i = 0; i < sectionMarkdown.cols; i++){
        boxes.push(createElement("div", {
            attributes: [createAttribute("style", `text-align: center; padding: 10px; background: rgba(255,255,255,0.3); color: #333; width: ${ sectionMarkdown.direction == 'row' ? `calc(100% / ${sectionMarkdown.cols})` : '100%' };`)]
        }))
    }
